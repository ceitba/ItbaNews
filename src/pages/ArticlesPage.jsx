        ...
        <div className="flex-1 px-6 py-5 flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
          <div>
            ...
            <p className="font-body text-body-sm text-ink-secondary mt-1">
              Los alumnos con cuenta <span className="font-semibold text-ink-primary">@itba.edu.ar</span> pueden proponer artículos y eventos. El equipo editorial los revisa antes de publicar.
            </p>
          </div>
          <Link
            to="/contribute"
